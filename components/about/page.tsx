...
const About = () => {
  return (
    <div className='imageBG bg-cover bg-center flex flex-col tablet:w-full tablet:m-auto tablet:bg-slate-800 tablet:flex-row tablet:h-[50rem]'>
      <div className='w-3/4  mx-10 tablet:w-1/2 tablet:ml-[10] m-auto flex flex-col justify-center items-center pt-10'>
        <Image src={about} alt={""} width={"0"} height={"0"} className={"w-48 h-48 border-8 rounded-full border-[#0bb0af]"}></Image>
        <h1 className='text-3xl text-center font-bold mt-5 text-gray-100'>M SHAYAN ALY</h1>
      ...
      <div className='w-4/5 m-auto space-x-3 tablet:w-2/3 tablet:mx-20 tablet:mt-[25%]  desktop:mt-[20%] tablet:pt-12 desktop:pt-0'>
